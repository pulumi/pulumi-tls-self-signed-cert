...
namespace Pulumi.TlsSelfSignedCert
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.TlsSelfSignedCert.version.txt");
    ...
    internal sealed class TlsSelfSignedCertResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public TlsSelfSignedCertResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
